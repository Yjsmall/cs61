...
public class LinkedListDequeTest {
    ...
    public void getTestEdge() {
        ...
        assertThat(lld1.get(23232)).isEqualTo(null);
    }
    @Test
    /** In this test, we have three different assert statements that verify that addFirst works correctly. */
    public void getTestRecursive() {
        Deque<String> lld1 = new LinkedListDeque<>();
        ...
        assertThat(lld1.getRecursive(23232)).isEqualTo(null);
    }
    ...
    public void removeFirstTestBasic() {
        ...
        lld1.addFirst("front"); // after this call we expect: ["front", "middle", "back"]
        assertThat(lld1.toList()).containsExactly("front", "back").inOrder();
        lld1.removeFirst();
        assertThat(lld1.toList()).containsExactly("back").inOrder();
